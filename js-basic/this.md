...
- new 绑定：如果函数或者方法调用之前带有关键字new，它就构成构造函数调用。对于this绑定来说，称为new 绑定。
...
这里主要是三个方法：apply/bind/call

我整理了一篇博客：[apply/call/bind 一网打尽](https://thelastto.github.io/2020/04/28/apply-call-bind/)
